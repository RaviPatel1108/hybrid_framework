...
class TestAddEmployee(WebdriverWrapper):
    ...
    @pytest.mark.parametrize("username, password, firstname, middlename, lastname, expected_name1, expected_first_name", test_add_employee_data)
    def test_add_valid_employee(self, username, password, firstname, middlename, lastname, expected_name1, expected_first_name):
